...
nlp = spacy.load("/data/codes/BARE_ablation/OneRef_ori/weights/spacy_models/en_core_web_md-3.7.1/en_core_web_md/en_core_web_md-3.7.1")
...
def get_sentencepiece_model_for_beit3(args):
    ...
    return XLMRobertaTokenizer("/data/codes/BARE_ablation/OneRef_ori/weights/beit3.spm")
